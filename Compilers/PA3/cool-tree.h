...
class Class__class : public tree_node {
 public:
  ...
  virtual void collect_feature(ClassInfo* class_info) const = 0;
  virtual void check_type(ClassTable* classtable, Class_ c) = 0;
...
class class__class : public Class__class {
 ...
 public:
  ...
  virtual void collect_feature(ClassInfo* class_info) const;
  virtual void check_type(ClassTable* classtable, Class_ c);
...
class formal_class : public Formal_class {
 ...
 public:
  ...
  virtual Symbol get_name() const { return name; }
  virtual Symbol get_type() const { return type_decl; }
  Formal copy_Formal();
  virtual void check_type(ClassTable* classtable, Class_ c);
  void dump(ostream& stream, int n);
...
class branch_class : public Case_class {
 ...
 public:
  ...
  void dump(ostream& stream, int n);
  virtual void check_type(ClassTable* classtable, Class_ c);
  virtual Symbol get_type_decl() const { return type_decl; }
  virtual Symbol get_type() const { return expr->get_type(); }
